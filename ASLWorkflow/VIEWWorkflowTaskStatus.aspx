<%@ Page Title="" Language="C#" MasterPageFile="~/WorkflowMaster.Master" AutoEventWireup="true" CodeBehind="VIEWWorkflowTaskStatus.aspx.cs" Inherits="ASLWorkflow.VIEWWorkflowTaskStatus" %>
...
<div id="bodyfontcolor">
        <table class="pageheader">
            <tr>
                <td >
                    <asp:Label ID="lblViewWorkflowTaskStatus" runat="server" Text="<% $Resources:lblViewWorkflowTaskStatus %>"></asp:Label>
                </td>
            </tr>
        </table>
