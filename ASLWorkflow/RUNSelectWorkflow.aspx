<%@ Page Title="" Language="C#" MasterPageFile="~/WorkflowMaster.Master" AutoEventWireup="true" CodeBehind="RUNSelectWorkflow.aspx.cs" Inherits="ASLWorkflow.RUNSelectWorkflow" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div id="EditSelectWF">
        <table class="pageheader">
            <tr>
                <td>
                    <asp:Label ID="lblRunSetupWorkflow" runat="server" Text="<% $Resources:lblRunSetupWorkflow %>"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
