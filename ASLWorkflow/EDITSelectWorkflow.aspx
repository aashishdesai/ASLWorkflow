<%@ Page Title="" Language="C#" MasterPageFile="~/WorkflowMaster.Master" AutoEventWireup="true"
    CodeBehind="EDITSelectWorkflow.aspx.cs" Inherits="ASLWorkflow.EDITSelectWorkflow"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="EditSelectWF">
        <table class="pageheader">
            <tr>
                <td>
                    <asp:Label ID="lblEditSelectWorkflow" runat="server" Text="<% $Resources:lblEditSelectWorkflow %>"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
