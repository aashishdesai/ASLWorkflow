<%@ Page Title="" Language="C#" MasterPageFile="~/WorkflowMaster.Master" AutoEventWireup="true" CodeBehind="SCHEDULEInitWF.aspx.cs" Inherits="ASLWorkflow.SCHEDULEInitWF" %>
...
<div id="bodyfontcolor">
        <table class="pageheader">
            <tr>
                <td >
                    <asp:Label ID="lblScheduleInitWF" runat="server" Text="<% $Resources:lblScheduleInitWF %>"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
